        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-row pt-4 font-size-16 font-baloo">
                    ...
                    <div class="col">
                    <form method="post">
                        <input type="hidden" name="item_id" value="<?php echo $item['item_id'] ?? $Cart->getCartId($product->getData('cart')) ?? []; ?>">
                        ...
                        if (in_array($item['item_id'], $Cart->getCartId($product->getData('cart')) ?? [])){
                            ...
                            echo '<button type="submit" name="prod_submit" class="btn btn-warning font-size-16 form-control">Add to Cart</button>';
                        }
                        ?>
                    </form>
                    </div>
            ...
            <div class="col-sm-6 py-5">
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        <td>You Save:</td>
                        <td><span class="font-size-16 text-danger">₹1000.00</span></td>
                    </tr>
                </table>
                <!---    !product price       -->
